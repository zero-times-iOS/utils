...
+ (NSString *) getFormatHM:(NSDate *)date
{
	int h = (int)[date hour];
	int m = (int)[date minute];

	NSString *hStr = h>9?[NSString stringWithFormat:@"%d",h]:[NSString stringWithFormat:@"0%d",h];
	NSString *mStr = m>9?[NSString stringWithFormat:@"%d",m]:[NSString stringWithFormat:@"0%d",m];

	return [NSString stringWithFormat:@"%@:%@",hStr,mStr];
}

+ (NSString *) getFormatMD:(NSDate *)date
{
	int h = (int)[date month];
	int m = (int)[date day];

	NSString *hStr = [NSString stringWithFormat:@"%d",h];
	NSString *mStr = [NSString stringWithFormat:@"%d",m];

	return [NSString stringWithFormat:@"%@月%@日",hStr,mStr];
}
